...
def main():
    ...
    sepal_length = float(st.text_input("Sepal Length"))
    sepal_width = float(st.text_input("Sepal Width"))
    petal_length = float(st.text_input("Petal Length"))
    petal_width = float(st.text_input("Petal Width"))
